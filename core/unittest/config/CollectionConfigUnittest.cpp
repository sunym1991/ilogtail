...
class CollectionConfigUnittest : public testing::Test {
public:
...
void CollectionConfigUnittest::HandleInvalidGlobal() const {
    unique_ptr<Json::Value> configJson;
    string configStr, errorMsg;
    unique_ptr<CollectionConfig> config;
...
void CollectionConfigUnittest::HandleInvalidFlushers() const {
    unique_ptr<Json::Value> configJson;
    string configStr, errorMsg;
    unique_ptr<CollectionConfig> config;
...
void CollectionConfigUnittest::HandleInvalidExtensions() const {
    unique_ptr<Json::Value> configJson;
    string configStr, errorMsg;
    unique_ptr<CollectionConfig> config;
...
UNIT_TEST_CASE(CollectionConfigUnittest, HandleInvalidProcessors)
UNIT_TEST_CASE(CollectionConfigUnittest, HandleInvalidAggregators)
