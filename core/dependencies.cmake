...
macro(link_spl target_name)
    ...
    target_link_libraries(${target_name} "liblog_reduce_lib.a")
    ...
    target_link_libraries(${target_name} "libpresto_shennong.a")
    ...
    # boost_context (still from deps root)
    ...
    target_link_libraries(${target_name} "libonig.a")

    # presto_server_lib <-> presto_sls_rpc
    target_link_libraries(${target_name} "libpresto_server_lib.a")
    target_link_libraries(${target_name} "libpresto_sls_rpc.a")
