...
# Add source files
file(GLOB THIS_SOURCE_FILES ${CMAKE_SOURCE_DIR}/plugin/task/*.c ${CMAKE_SOURCE_DIR}/plugin/task/*.cc ${CMAKE_SOURCE_DIR}/plugin/task/*.cpp ${CMAKE_SOURCE_DIR}/plugin/task/*.h)
list(APPEND THIS_SOURCE_FILES_LIST ${THIS_SOURCE_FILES})

if(NOT UNIX OR NOT ENABLE_ENTERPRISE)
    list(REMOVE_ITEM THIS_SOURCE_FILES_LIST
        ${CMAKE_SOURCE_DIR}/plugin/task/TaskApmForward.cpp
        )
endif()
